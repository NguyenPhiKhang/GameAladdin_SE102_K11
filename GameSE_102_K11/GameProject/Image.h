...
public:
	...
	// Set TextureManager
	virtual void setTextureManager(LPTEXTURE textureM)
	{
		if (!initialize(textureM))
			DebugOut("Error set Texture Manager!");
	}
	...
	virtual bool Image::initialize(LPTEXTURE textureM);
